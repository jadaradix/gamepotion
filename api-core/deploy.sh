...
docker run --name oscar-production-api-core -p 1025:8000 -d storydust/oscar-production-api-core;
sleep 5s;
curl localhost:1025;

# docker rm oscar-production-api-core;
# docker build -t oscar-production-api-core .;
# docker run --name oscar-production-api-core -p 1025:8000 -d oscar-production-api-core;
